  ...
  return (
   <div>
    <div className='flex text-white justify-between items-center h-24 max-w-[1240px] mx-auto px-4'>
      ...
      <div className={!nav ? 'fixed left-0 top-0 w-[60%] h-full border-r border-r-gray-800 bg-black ease-in-out duration-500':'fixed left-[-100%]'}>
      <h1 className='w-full text-3xl font-bold text-[#00df9a] m-7'>GIG</h1>
