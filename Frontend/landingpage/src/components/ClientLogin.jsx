 ...
 function ClientLogin() {
  ...
  return (
    ...
    <div className=' h-[100vh] flex flex-col items-center justify-center text-white'>
        <img className='h-[320px] w-80  rounded-2xl my-4 flex justify-normal absolute opacity-93' src={image}/>
        <div className='h-[320px] w-80 bg-[#8ca491] rounded-2xl px-6 my-4 overflow-hidden'  >
            ...
            <div className={`${open ?"translate-y-[0px] transition-all":"translate-y-[400px] transition-all"}`}>
                ...
                <form className="flex flex-col items-center " action=''>
                    ...
                    <div className='w-full  relative'>
                        <input className="border border-gray-500 rounded-full py-2 px-4 my-2 bg-transparent w-full hover:opacity-10"required type='text' placeholder='name'/>
