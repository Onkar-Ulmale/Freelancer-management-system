      ...
      <table class="min-w-full divide-y divide-gray-200">
          <thead class="bg-gray-50">
              <tr >
                  ...
                  <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Accept/Ignore</th>
              </tr>
          </thead>
          ...
          {project.length>0?(
              ...
              <tr class="hover:bg-gray-100 transition duration-300 ease-in-out" key={email}>
                  ...
                  <td> <motion.button
        className="bg-green-500  text-lg font-semibold py-1 px-8 rounded-full shadow-lg focus:outline-none text-black" onClick={accepts}
        whileHover={{ scale: 1, backgroundColor: "#1D4ED8" }} // Blue color
